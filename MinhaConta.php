...
<body>
    ...
    <div class="container text-center">
        ...
        <!-- Botão para limpar os acordeões com JavaScript -->
        <button id="limparAcordeons" class="btn btn-warning">Limpar Orçamentos</button>
    </div>

    <script>
        // Adicionando um evento de clique ao botão para limpar os acordeões
        document.getElementById('limparAcordeons').addEventListener('click', function() {
